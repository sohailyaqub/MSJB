 ...
 *         &lt;element name="arg1" type="{http://persistance.core.wikimnv.cap.fr/}meta" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FaireRequete {
     ...
     * 
     */
    public List<Meta> getArg1() {
        if (arg1 == null) {
            arg1 = new ArrayList<Meta>();
        }
        return this.arg1;
    }
